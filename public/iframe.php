...
if (!empty($_REQUEST['saved'])) {
    $message = 'Настройки успешно сохранены. Соединение с сервером Екомкасса успешно установлено.';
}

if (!empty($_REQUEST['credentials'])) {
    $error = 'Не получилось подключиться к серверу Екомкасса с указанным логином и паролем. Проверьте правильность заполнения логина и пароля и сохраните настройки еще раз.';
}
